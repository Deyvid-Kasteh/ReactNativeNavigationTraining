...
function Drawer_tab_Group() {
  return (
    <Drawer_tab.Navigator>
      <Drawer_tab.Screen name="Drawer" component={Drawer1} />
      <Drawer_tab.Screen name="Drawer" component={Drawer2} />
      <Drawer_tab.Screen name="Drawer" component={Drawer3} />
      <Drawer_tab.Screen name="Drawer" component={Drawer4} />
      <Drawer_tab.Screen name="Drawer" component={Drawer5} />
    </Drawer_tab.Navigator>
  );
}
